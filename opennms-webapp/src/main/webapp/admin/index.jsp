...
<div class="row">
  <div class="col-md-6">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <ul class="list-unstyled">
            <li><a href="#admin/requisitions" target="_parent">Manage Provisioning Requisitions</a></li>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <ul class="list-unstyled">
            <li><a href="#admin/monitoringLocations" target="_parent">Manage Monitoring Locations</a></li>
