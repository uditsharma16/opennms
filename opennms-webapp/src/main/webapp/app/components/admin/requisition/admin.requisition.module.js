...
(function() {
  ...
  .config(['$routeProvider', function ($routeProvider) {
    ...
    .when('/admin/requisitions', {
      templateUrl: 'app/components/admin/requisition/views/requisitions.html',
      controller: 'RequisitionsController'
    })
    .when('/admin/requisitions/:foreignSource', {
      templateUrl: 'app/components/admin/requisition/views/requisition.html',
      controller: 'RequisitionController'
    })
    .when('/admin/requisitions/:foreignSource/foreignSource', {
      templateUrl: 'app/components/admin/requisition/views/foreignsource.html',
      controller: 'ForeignSourceController'
    })
    .when('/admin/requisitions/:foreignSource/nodes/:foreignId', {
      templateUrl: 'app/components/admin/requisition/views/node.html',
      controller: 'NodeController'
    })
    .when('/admin/requisitions/:foreignSource/nodes/:foreignId/vertical', {
      templateUrl: 'app/components/admin/requisition/views/node-panels.html',
      controller: 'NodeController'
    })
    .when('/admin/requisitions/quickaddnode', {
        templateUrl: 'app/components/admin/requisition/views/quick-add-node-standalone.html',
