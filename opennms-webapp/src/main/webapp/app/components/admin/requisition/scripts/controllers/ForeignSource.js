    ...
    */
    $scope.editPolicy = function(policy, isNew) {
      ...
      $uibModal.open({
        ...
        templateUrl: 'app/components/admin/requisition/views/policy.html',
        resolve: {
    ...
    */
    $scope.movePolicy = function(policy) {
      ...
      $uibModal.open({
        ...
        templateUrl: 'app/components/admin/requisition/views/move.html',
        resolve: {
    ...
    */
    $scope.editDetector = function(detector, isNew) {
      ...
      $uibModal.open({
        ...
        templateUrl: 'app/components/admin/requisition/views/detector.html',
        resolve: {
